        ...
        <form onSubmit={handleSubmit}>
          <div className="admin-grid-container">
            ...
            <div className="admin-field">
              ...
              <input type="text" id="admin-academy-name" className="admin-input" placeholder="Nombre de la Academia" value={academyName} onChange={(e) => setAcademyName(e.target.value)} required />
            </div>
            {/* Fecha de Inscripción */}
            <div className="admin-field">
              <label className="admin-label" htmlFor="admin-registration-date">Fecha de Inscripción</label>
              <input type="date" id="admin-registration-date" className="admin-input" value={registrationDate} onChange={(e) => setRegistrationDate(e.target.value)} required />
            </div>
            {/* Nombre del Director */}
            <div className="admin-field">
              <label className="admin-label" htmlFor="admin-director-name">Nombre del Director</label>
              <input type="text" id="admin-director-name" className="admin-input" placeholder="Nombre del Director" value={directorName} onChange={(e) => setDirectorName(e.target.value)} required />
            </div>
            {/* Teléfono del Director */}
            <div className="admin-field">
              <label className="admin-label" htmlFor="admin-director-phone">Teléfono del Director</label>
              <input type="tel" id="admin-director-phone" className="admin-input" placeholder="Teléfono del Director" value={directorPhone} onChange={(e) => setDirectorPhone(e.target.value)} required />
            </div>
          </div>
          {/* Mensaje de error si lo hay */}
          {error && <p className="admin-error-message">{error}</p>}
          {/* Botón de enviar */}
          <button type="submit" className="admin-submit-button">Inscribir Academia</button>
        </form>
      </div>
